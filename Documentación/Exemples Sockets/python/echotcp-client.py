...
SYNOPSIS
    ...
    echotcp-client.py [-h,--help] [--version] [p, --port <port>, default=1234]
        [-d, --destination <address>, default=127.0.0.1]

DESCRIPTION

    Creates a ECHO/TCP client, connects to server, sends data and 
...
__program__ = "echotcp-client"
__version__ = '0.0.1'
__author__ = 'Carles Mateu <carlesm@carlesm.com>'
__copyright__ = 'Copyright (c) 2012  Carles Mateu '
__license__ = 'GPL3+'
__vcs_id__ = '$Id: echotcp-client.py 551 2012-05-05 11:52:38Z carlesm $'
...
def setup():
    ...
    sock.connect((options.destination, options.port))
